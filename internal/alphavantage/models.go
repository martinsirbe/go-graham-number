...
type Overview struct {
	...
	WeekHigh                   string `json:"52WeekHigh"`
	WeekLow                    string `json:"52WeekLow"`
	DayMovingAverage           string `json:"50DayMovingAverage"`
	DayMovingAverage1          string `json:"200DayMovingAverage"`
